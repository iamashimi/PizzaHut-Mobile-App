...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button select_pizza_button = findViewById( R.id.selectPizza );

        d_button.setOnClickListener(this);
        t_button.setOnClickListener(this);
        login_button.setOnClickListener( this );
        reg_button.setOnClickListener( this );
        select_pizza_button.setOnClickListener( this );
        ...
        select_pizza_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int2 = new Intent(MainActivity.this,SearchPizza.class);
                startActivity(int2);
            }
        });
